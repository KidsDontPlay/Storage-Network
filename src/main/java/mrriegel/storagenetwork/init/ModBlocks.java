...
public class ModBlocks {
	...
	public static void init() {
		...
		GameRegistry.registerBlock(kabel.setUnlocalizedName(kabel.getRegistryName()), BlockKabel.Item.class);
		GameRegistry.registerBlock(storageKabel.setUnlocalizedName(storageKabel.getRegistryName()), BlockKabel.Item.class);
		GameRegistry.registerBlock(exKabel.setUnlocalizedName(exKabel.getRegistryName()), BlockKabel.Item.class);
		GameRegistry.registerBlock(imKabel.setUnlocalizedName(imKabel.getRegistryName()), BlockKabel.Item.class);
		GameRegistry.registerBlock(vacuumKabel.setUnlocalizedName(vacuumKabel.getRegistryName()), BlockKabel.Item.class);
		GameRegistry.registerBlock(fstorageKabel.setUnlocalizedName(fstorageKabel.getRegistryName()), BlockFKabel.Item.class);
		GameRegistry.registerBlock(fexKabel.setUnlocalizedName(fexKabel.getRegistryName()), BlockFKabel.Item.class);
		GameRegistry.registerBlock(fimKabel.setUnlocalizedName(fimKabel.getRegistryName()), BlockFKabel.Item.class);
